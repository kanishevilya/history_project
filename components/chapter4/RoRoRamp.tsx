...
export function RoRoRamp({
  ...
  return (
    <div
      ref={ref}
      className="ch4-iso-plate ch4-plate--2 mt-12 border-[#0284c7] p-0"
    >
      <div className="grid gap-0 md:grid-cols-[1fr_300px] md:items-stretch">
        ...
        <div className="ch4-ramp-perspective order-1 md:order-2">
          <motion.div style={{ rotateX }} className="origin-bottom">
            <div className="ch4-corrugated relative min-h-[220px]">
              <Image
                src={imageSrc}
                alt={alt}
          ...
          <p className="ch4-meta mt-3 px-4 pb-4 text-[#0284c7]">
            Аппарель · ро-ро
          </p>
        </div>
      </div>
